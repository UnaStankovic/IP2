...
\begin{primer}
Nakon što smo prikupili neke podatke sa stranica, želimo sada i na neki način da te podatke analiziramo. U ovom primeru želimo da vršimo pretragu stranica na osnovu traženih pojmova, koje unosimo u vidu $query\_string$. 
